...
package gradle.kotlin.dsl.plugins._678654373ae78c68e0d910f08607ff2d
...
/**
 * The `com.squareup` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComSquareupPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.squareup`.
 */
internal
val `ComPluginGroup`.`squareup`: `ComSquareupPluginGroup`
    get() = `ComSquareupPluginGroup`(plugins)


/**
 * The `com.squareup.sort-dependencies` plugin implemented by [com.squareup.sort.SortDependenciesPlugin].
 */
internal
val `ComSquareupPluginGroup`.`sort-dependencies`: PluginDependencySpec
    get() = plugins.id("com.squareup.sort-dependencies")
...
/**
 * The `io.github.pemistahl` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubPemistahlPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.pemistahl`.
 */
internal
val `IoGithubPluginGroup`.`pemistahl`: `IoGithubPemistahlPluginGroup`
    get() = `IoGithubPemistahlPluginGroup`(plugins)


/**
 * The `io.github.pemistahl.version-catalog-linter` plugin implemented by [io.github.pemistahl.versioncatalog.linter.plugin.VersionCatalogLinterPlugin].
 */
internal
val `IoGithubPemistahlPluginGroup`.`version-catalog-linter`: PluginDependencySpec
    get() = plugins.id("io.github.pemistahl.version-catalog-linter")
